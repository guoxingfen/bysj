...
function getskincookie(){
	...
	if(hrefStr!=undefined){
		var hrefRes=hrefStr.substring(0,hrefStr.lastIndexOf('skin/'))+'/bysj/admin/skin/'+v+'/skin.css';
...
$(function(){
	...
	$("#Hui-skin .dropDown-menu a").click(function(){
		...
		$.cookie("Huiskin", v);
		$("#skin").attr("href","/bysj/admin/skin/"+v+"/skin.css");
		$(window.frames.document).contents().find("#skin").attr("href","/bysj/admin/skin/"+v+"/skin.css");
	});
}); 
